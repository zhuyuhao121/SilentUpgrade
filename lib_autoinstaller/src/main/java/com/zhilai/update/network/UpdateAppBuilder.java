...
public class UpdateAppBuilder {
    ...
    private Context mActivity;//上下文对象
    ...
    public static AutoInstaller.MODE mode = AutoInstaller.MODE.ROOT_ONLY;

    private UpdateAppBuilder(Context activity) {
    ...
    public static UpdateAppBuilder with(Context activity) {
     ...
     * @return
     */
    public UpdateAppBuilder isAutoRestart(boolean isAutoRestart) {
        UpdateAppBuilder.isAutoRestart = isAutoRestart;
        return this;
    }

    /**
     * 是否增量更新
     * @param isIncrementalUpdate
     * @return
     */
    public UpdateAppBuilder isIncrementalUpdate(boolean isIncrementalUpdate) {
        UpdateAppBuilder.isIncrementalUpdate = isIncrementalUpdate;
        return this;
    }

    public UpdateAppBuilder instalMode(AutoInstaller.MODE mode) {
        UpdateAppBuilder.mode = mode;
        return this;
    }
    ...
    public UpdateAppBuilder setAutoInstallListener(OnAutoInstallListener onAutoInstallListener){
...
//            }
        ...
        public void onNetConnected(NetUtils.NetType type) {//网络连接
            if (type == NetUtils.NetType.WIFI) {
                ...
                mDownloadid = DownloadManager.
                        ...
                        isForce(isForce).startDownload(onAutoInstallListener);
     ...
     */
    private void doNewVersionUpdate(final Context mContext) {
